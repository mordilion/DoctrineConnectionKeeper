...
use Doctrine\DBAL\Connections\MasterSlaveConnection as DBALMasterSlaveConnectionAlias;
use Doctrine\DBAL;
 ...
 */
class MasterSlaveConnection extends DBALMasterSlaveConnectionAlias implements ConnectionInterface
{
    use ConnectionTrait {
